...
export const config = {
  PORT: process.env.GOLDI_FRONTEND_PORT
    ? parseInt(process.env.GOLDI_FRONTEND_PORT)
    : 9000,
  ...
  CWIDE_STANDALONE_URL:
    process.env.CWIDE_STANDALONE_URL ?? "https://www.goldi-labs.de/cwide/",
