import { AndExpression, OrExpression, NotExpression, InputVariableExpression, StateVariableExpression, OutputVariableExpression } from "./LogicExpressions";
const orChar = '|';
const andChar = '&';
const notChar = '!';
...
export function stringToLogicExpression(equationString, environment) {
...
function stringToSmallExpression(str, environment) {
    let rv;
    switch (str.charAt(0)) {
        case notChar:
...
function splitStringIgnoreBrackets(equationString, splitChar) {
    let bracketLevel = 0;
    let split = [];
    let stringBuilder = "";
...
//# sourceMappingURL=EquationParser.js.map