...
import { getCurrentInputsSelector, getCurrentOutputsSelector, getCurrentStatesSelector, getIsSequentialSelector } from "../model/selectors";
import BoolPropOptions from "../model/BooleanProperty";
import { dispatchClockEvent, dispatchResetEvent, dispatchUserChangeEvent, ExportEvent } from "../model/Events";
...
let Menu = /** @class */ (() => {
    let Menu = class Menu extends connect(store)(LitElement) {
        constructor() {
            super(...arguments);
        ...
        updated(changedProperties) {
            ...
            this.shadowRoot.querySelectorAll(".mdc-form-field").forEach(formField => {
                if (formField.controllerObject === undefined) {
                    formField["controllerObject"] = MDCFormField.attachTo(formField);
                    formField.input = this.shadowRoot.getElementById("checkbox-" + formField.id.split("form-field-")[1]).controllerObject;
                }
            });
            if (this.isSequential) {
                ...
                setTimeout((caller) => {
                    caller.shadowRoot.getElementById("mce-step-number-input").style.width =
                        String(caller.shadowRoot.getElementById("for-mce-step-number-input").clientWidth) + "px";
                }, 100, this); // for firefox this could be 0 timeout but chrome says no
                setTimeout((caller) => {
                    caller.shadowRoot.getElementById("mce-period-input").style.width =
                        String(caller.shadowRoot.getElementById("for-mce-period-input").clientWidth) + "px";
                }, 100, this);
            }
            else {
        ...
        openExportMenu() {
            this.shadowRoot.getElementById('exportMenu').controllerObject.open = true;
        }
        openLanguageMenu() {
            this.shadowRoot.getElementById('languageMenu').controllerObject.open = true;
        }
        openVisibilityMenu() {
            this.shadowRoot.getElementById('visibilityMenu').controllerObject.open = true;
        }
    ...
    ], Menu.prototype, "isSequential", void 0);
    __decorate([
        property(BoolPropOptions)
    ], Menu.prototype, "multiClockExecutionActive", void 0);
    __decorate([
        property(BoolPropOptions)
    ], Menu.prototype, "viewMode", void 0);
    __decorate([
        property({ type: Object })
    ], Menu.prototype, "inputs", void 0);
    __decorate([
        property({ type: Object })
    ], Menu.prototype, "states", void 0);
    __decorate([
        property({ type: Object })
    ], Menu.prototype, "outputs", void 0);
    Menu = __decorate([
