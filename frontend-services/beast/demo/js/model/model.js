...
class PersistenceController {
    ...
    getLastSessionProject() {
        ...
        if (data === null) {
            ...
            const dirtyMarker = sessionStorage.getItem(PersistenceController.SESSION_DIRTY_KEY);
            if (dirtyMarker === null) {
    ...
    saveCurrentProjectInLocalStorage() {
        const list = PersistenceController.getProjects();
     ...
     */
    static deleteLocalProject(name) {
        const arr = PersistenceController.getProjects();
     ...
     */
    static getProjects() {
        const data = localStorage.getItem(PersistenceController.LOCAL_PROJECT_LIST_KEY);
