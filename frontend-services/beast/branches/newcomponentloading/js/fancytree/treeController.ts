...
class TreeController
{
    ...
    public treeData : Array<Library>;
    public BeastController : BeastController;
    
    constructor(controller : treeControllerInterface, BeastController)
        {
     ...
     * @param treeNode
     */
    private deleteComponent = (treeNode) =>
    {
     ...
     * @param lib
     */
    private deleteComponents = (event, treeNode, lib : Array<Library>) =>
    {
     ...
     */
    public searchTree(lib, key, parent)
        {
            let isBasic   = false;
            let indexLib  = -1;
            let indexComp = -1;
    ...
    public buildTree(controller)
        {
            ...
            $('#tree')
                .fancytree(<FancytreeOptions> {
                    ...
                    contextMenu  : {
                        menu    : {   //TODO: Don't show Edit option for basic components
