...
var simcir = function($) {
    ...
    var offset = function($o, prex?: number, prey?: number) {
        var x = prex || 0;
        var y = prey || 0;
    ...
    var createWorkspace = function(data, $container) {
        ...
        !function() {
            ...
            $defs.append(createSVGElement('pattern').
                                                    attr({id: patId, x: 0, y: 0,
                                                             width: patternPitch / w, height: patternPitch / h}).append(
        ...
        var tranformEventCoords = function(e: MouseEvent): position {
        ...
        var zoomRelative = function(zoomfactor:number, center?:position)
        {
        ...
        $workspace.on('wheel', (event) => zoomRelative(1+Math.sign((<any>event.originalEvent).deltaY) / 10, getEventPos(event)));
        ...
        var workspaceController = {
            ...
            markDirty: () => (null),
            openCompound: (identifier: ComponentIdentifier) => (null),
