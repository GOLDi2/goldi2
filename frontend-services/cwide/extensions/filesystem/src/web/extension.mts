...
import {
  ...
  FileSystemServiceProducer,
  fileSystemProtocol,
} from "@cross-lab-project/soa-service-filesystem";
...
import { convertToCollaborationDirectory } from "@cross-lab-project/filesystem-schemas";
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  const fileSystemServiceProducer = new FileSystemServiceProducer(
    "filesystem:producer"
  );
  ...
  const filesystemServiceConsumer = new FileSystemServiceConsumer(
    "filesystem:consumer"
  );
