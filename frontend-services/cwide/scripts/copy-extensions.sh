...
npm --prefix extensions/base ci
npm --prefix extensions/base run build
...
npm --prefix extensions/collaboration ci
npm --prefix extensions/collaboration run build
...
npm --prefix extensions/compilation ci
npm --prefix extensions/compilation run build
...
npm --prefix extensions/debugging ci
npm --prefix extensions/debugging run build
...
npm --prefix extensions/filesystem ci
npm --prefix extensions/filesystem run build
...
npm --prefix extensions/lsp ci
npm --prefix extensions/lsp run build
...
npm --prefix extensions/testing ci
npm --prefix extensions/testing run build
