...
architecture TB of BUS_ADAPTOR_TB is
    ...
    constant p_master_bus_i : mbus_in                                           := gnd_mbus_i;
...
begin
    ...
    begin
        ...
        p_config_word_i <= "1" & "0" & std_logic_vector(to_unsigned(3, BUS_TAG_BITS)) & std_logic_vector(to_unsigned(240, BUS_ADDRESS_WIDTH));
        p_word_val      <= '1';
        wait for clk_period;
        ...
        wait for 2 * clk_period;
        --Configuration word: "we" & "se" & "tag(3)" & "address(240)"
        p_config_word_i <= "1" & "1" & std_logic_vector(to_unsigned(3, BUS_TAG_BITS)) & std_logic_vector(to_unsigned(240, BUS_ADDRESS_WIDTH));
        p_word_val      <= '1';
        wait for clk_period;
        p_config_word_i <= std_logic_vector(to_unsigned(0, CONFIGURATION_WORD));
        p_word_val      <= '0';
