...
begin
    ...
    begin
        ...
        --Port configuration
        p_spi_nce          <= '0';
        cmosi_buffer       <= "1" & "0" & std_logic_vector(to_unsigned(3, BUS_TAG_BITS)) & std_logic_vector(to_unsigned(240, BUS_ADDRESS_WIDTH));
        ...
        report "ID16: Test second data transfer - expecting master_bus_o.adr = x0EE " & integer'image(to_integer(unsigned(p_master_bus_o.adr)))
        severity error;
