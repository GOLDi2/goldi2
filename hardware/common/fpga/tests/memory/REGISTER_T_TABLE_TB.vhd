...
architecture TB of REGISTER_T_TABLE_TB is
    ...
    constant tag_buff      : std_logic_vector(3 * BUS_TAG_BITS - 1 downto 0)      := std_logic_vector(to_unsigned(3, BUS_TAG_BITS)) & std_logic_vector(to_unsigned(2, BUS_TAG_BITS)) & std_logic_vector(to_unsigned(1, BUS_TAG_BITS));
