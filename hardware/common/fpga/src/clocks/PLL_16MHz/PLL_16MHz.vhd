...
-- Module  Version: 5.7
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n PLL_16MHz -lang vhdl -synth lse -arch xo2c00 -type pll -fin 48 -fclkop 16 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 
...
architecture Structure of PLL_16MHz is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  0, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  32, 
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  33, CLKFB_DIV=>  1, CLKI_DIV=>  3, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of PLL_16MHz is
    for Structure
