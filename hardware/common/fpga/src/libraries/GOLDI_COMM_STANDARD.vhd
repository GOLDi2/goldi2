...
package GOLDI_COMM_STANDARD is
    ...
    --allows changes to the SYSTEM_DATA_WIDTH constant for simulation or synthesis of the 
    --module as an independent unit. 
    constant reg_table_d_default : data_word_vector(2 downto 0) := (std_logic_vector(to_unsigned(255, SYSTEM_DATA_WIDTH)),
    ...
    --an independent unit. 
    constant reg_table_t_default : tag_word_vector(2 downto 0) := (others => (others => '0'));
    -------------------------------------------------------------------------------------------------------------------
