...
architecture RTL of UART_STD_ENCODER is
    ...
    --****INTERNAL SIGNALS****
    alias start_bit      : std_logic is p_eword_tdata(0);
    alias data_bits      : std_logic_vector(g_data_width-1 downto 0) is p_eword_tdata(g_data_width downto 1);
    alias parity_bit     : std_logic is p_eword_tdata(g_data_width + 1);
    alias stop_bits      : std_logic_vector(g_encoded_length-g_data_width-g_parity_bit-2 downto 0) is p_eword_tdata(g_encoded_length - 1 downto g_data_width + g_parity_bit + 1);
    --Flags
