...
import { testCase as io_board_cable_test } from './io_board_cable_test'
import { testCase as io_board_configuration_test } from './io_board_configuration_test'

export const testCasesMicrocontroller = [
    // ethernet_test,
    // false_test,
    fpga_clock_test,
    rpi_gpio_test,
