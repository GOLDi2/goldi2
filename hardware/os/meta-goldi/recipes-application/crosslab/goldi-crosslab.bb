...
SRC_URI = " \
    file://${GIT_DIR}/hardware/boards/${MACHINE_VARIANT}/crosslab/dist/${@'${MACHINE_VARIANT}'.replace('-', '_')}_crosslab-0.0.1.tar.gz \
"
...
S = "${WORKDIR}/${@'${MACHINE_VARIANT}'.replace('-', '_')}_crosslab-0.0.1"
inherit setuptools3
