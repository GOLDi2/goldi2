...
begin
    ...
    act_mask(17) <= '0' when ((limit_x_neg = '1' and limit_x_pos = '1') or (limit_x_neg = '1' and limit_x_ref = '1') or (limit_x_pos = '1' and limit_x_ref = '1') or (x_out_neg = '1' and x_out_pos = '1') or (limit_z_pos = '0')) else
                    '1';

    --Mask Bit for x_out_1 / x_out_pos channel
    act_mask(18) <= '0' when ((limit_x_pos = '1') or (limit_x_neg = '1' and limit_x_ref = '1') or (x_out_neg = '1' and x_out_pos = '1') or (limit_z_pos = '0')) else
                    '1';

    --Mask Bit for x_out_2 / x_out_neg channel                
    act_mask(19) <= '0' when ((limit_x_neg = '1') or (limit_x_pos = '1' and limit_x_ref = '1') or (x_out_neg = '1' and x_out_pos = '1') or (limit_z_pos = '0')) else
                    '1';

    --Mask Bit for y_enable channel
    act_mask(20) <= '0' when ((limit_y_neg = '1' and limit_y_pos = '1') or (limit_y_neg = '1' and limit_y_ref = '1') or (limit_y_pos = '1' and limit_y_ref = '1') or (y_out_neg = '1' and y_out_pos = '1') or (limit_z_pos = '0')) else
                    '1';

    --Mask Bit for y_out_1 / y_out_neg channel
    act_mask(21) <= '0' when ((limit_y_neg = '1') or (limit_y_pos = '1' and limit_y_ref = '1') or (y_out_neg = '1' and y_out_pos = '1') or (limit_z_pos = '0')) else
                    '1';

    --Mask Bit for y_out_2 / y_out_pos channel
    act_mask(22) <= '0' when ((limit_y_pos = '1') or (limit_y_neg = '1' and limit_y_ref = '1') or (y_out_neg = '1' and y_out_pos = '1') or (limit_z_pos = '0')) else
                    '1';

    --Mask Bit for z_enable channel               
    act_mask(23) <= '0' when ((limit_z_neg = '1' and limit_z_pos = '1') or (z_out_neg = '1' and z_out_pos = '1')) else
                    '1';

    --Mask Bit for z_out_1 / z_out_pos channel
    act_mask(24) <= '0' when ((limit_z_pos = '1') or (z_out_neg = '1' and z_out_pos = '1')) else
                    '1';

    --Mask Bit for z_out_2 / z_out_neg channel
    act_mask(25) <= '0' when ((limit_z_neg = '1') or (z_out_neg = '1' and z_out_pos = '1')) else
                    '1';
