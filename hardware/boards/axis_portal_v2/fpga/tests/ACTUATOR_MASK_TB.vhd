...
begin
    ...
    begin
        for i in 0 to (2 ** 13) - 1 loop
            ...
            --Mask test
            --X step channel
            if ((limit_x_neg = '1' and limit_x_pos = '1') or (limit_x_neg = '1' and motor_x_dir = '0') or (limit_x_pos = '1' and motor_x_dir = '1') or (limit_z_pos = '0')) then

                assert (x_step_s = '0')
                report "ID01: Expecting x_step_s = '0'" severity error;
            end if;

            if ((limit_y_neg = '1' and limit_y_pos = '1') or (limit_y_neg = '1' and motor_y_dir = '0') or (limit_y_pos = '1' and motor_y_dir = '1') or (limit_z_pos = '0')) then

                assert (y_step_s = '0')
                report "ID02: Expecting y_step_s = '0'" severity error;
            end if;

            if ((limit_z_neg = '0' and limit_z_pos = '1') or (limit_z_neg = '0' and motor_z_pos = '1') or (limit_z_pos = '1' and motor_z_neg = '1')) then
