...
import { ProtocolMessage } from "@cross-lab-project/abstract-messaging-channel";
import { CompilationProtocol,CompilationService__Producer } from "@cross-lab-project/soa-service-compilation";
import fs from "fs";
import path from "path";
import os from "os";
import { execSync } from "child_process";
import { arduinoCliResultFormats, ArduinoCliResultFormats } from "./types.js";
...
export class ArduinoCliCompilationInstance {
  ...
  public async connect() {
    ...
    if (typeof token !== "string") {
      throw new Error("Expected websocket token to be of type string!")
    }
